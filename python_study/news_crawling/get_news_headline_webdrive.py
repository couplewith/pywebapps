...
url= 'https://news.naver.com/main/main.nhn?mode=LSD&mid=shm&sid1=101' #경제
url2 = "https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=105"  #연예
url9 = 'https://news.daum.net/breakingnews/digital'
...
#             '#main_content > div > div._persist > div:nth-child(1) > div:nth-child(2)'
...
for news in soup.select(html_selector):
    ...
    item_desc  = news.select_one('div.cluster_text_lede').get_text()
